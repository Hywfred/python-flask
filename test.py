...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        ...
        self.assertEqual(u1.followed.first().username, "jerry")
        self.assertEqual(u2.followers.count(), 1)
        self.assertEqual(u2.followers.first().username, "tom")
    ...
    def test_follow_posts(self):
        ...
        now = datetime.utcnow()
        p1 = Post(
            body="post from spike", author=u1, timestamp=now + timedelta(seconds=1)
        )
        p2 = Post(
